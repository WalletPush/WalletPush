...
// Loyalty Components
const BalanceHeader = ({ points, currency, tier }: any) => (
    ...
    <CardContent className="p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-purple-100 text-sm">{currency || 'points'}</p>
        </div>
