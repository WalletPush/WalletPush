...
-- This creates the complete webhook + automation system
...
-- 9. Insert some sample automations for demonstration
-- (These will be filtered by business_id via RLS)
...
-- Sample action types that can be stored in the actions JSONB:
-- {
